...
export const CleaningHeuristics: CleaningHeuristic[] =
  [
    ...
    },
    {
      ...
      description:
        "Clean interior spaces before exterior areas",
      checklist: [
    ...
    },
    {
      ...
      description:
        "Use all five senses to ensure thorough cleaning",
      checklist: [
    ...
    },
    {
      ...
      description:
        "View each room as a guest would see it",
      checklist: [
    ...
    },
    {
      ...
      description:
        "Test all appliances and systems after cleaning",
      checklist: [
    ...
    },
    {
      ...
      description:
        "Systematically check areas that are easily overlooked",
      checklist: [
    ...
    },
    {
      ...
      description:
        "Ensure all necessary supplies are stocked and accessible",
      checklist: [
    ...
    },
    {
      ...
      description:
        "Verify all safety and security measures are in place",
      checklist: [
    ...
    },
    {
      ...
      description:
        "Adjust cleaning based on season and weather",
      checklist: [
    ...
    },
    {
      ...
      description:
        "Final comprehensive check before considering cleaning complete",
      checklist: [
